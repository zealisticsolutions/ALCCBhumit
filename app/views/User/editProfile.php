					...
					<div class="row">
						...
						<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="datepicker" readonly placeholder="DD-MM-YYYY" name="dob" value="<?php if($_POST['dob'] != "0000-00-00 00:00:00"){echo date("d-m-Y", strtotime($_POST['dob']));} ?>" class="from-control date-picker">	
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="datepicker2" readonly placeholder="DD-MM-YYYY" name="marriage_date" value="<?php if($_POST['marriage_date'] != "0000-00-00 00:00:00" ){echo date("d-m-Y", strtotime($_POST['marriage_date']));} ?>" class="from-control date-picker">	
								</div>
							</div>
							...
							-->
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right email_address_patient <?php if(!empty($_POST['type']) And $_POST['type'] != 3){ echo "required"; }?> " for="form-field-1"> Email Address </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="Email Address" name="email" value="<?php if(!empty($_POST['email'])){echo $_POST['email'];} ?>" class="col-xs-10 col-sm-5" />
									<?php if(!empty($tpl['errorMsg']['email'])) {?>
										<br><br><label class="errMsg"><?php echo $tpl['errorMsg']['email']; ?></label>
									<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select class="chosen-select aura_select form-control user_type_patient" required name="type" id="form-field-select-3" data-placeholder="Choose a State...">
										<option value="">Select  </option>
										<?php if(!empty($_SESSION["USER_TYPE"]) And $_SESSION["USER_TYPE"] == 1){ ?>
											<option value="1" <?php if(!empty($_POST['type']) And $_POST['type'] == 1){echo "Selected";} else { echo "disabled"; } ?>>Admin</option>
											<option value="6" <?php if(!empty($_POST['type']) And $_POST['type'] == 6){echo "Selected";} else { echo "disabled"; } ?>>Doctor</option>
											<option value="4" <?php if(!empty($_POST['type']) And $_POST['type'] == 4){echo "Selected";} else { echo "disabled"; } ?>>Receptionist</option>
											<option value="7" <?php if(!empty($_POST['type']) And $_POST['type'] == 7){echo "Selected";} else { echo "disabled"; } ?>>Manager</option>
											<option value="2" <?php if(!empty($_POST['type']) And $_POST['type'] == 2){echo "Selected";} else { echo "disabled"; } ?>>Therapist</option>
											<option value="5" <?php if(!empty($_POST['type']) And $_POST['type'] == 5){echo "Selected";} else { echo "disabled"; } ?>>Counsellor</option>
										<?php } ?>
										<option value="3" <?php if(!empty($_POST['type']) And $_POST['type'] == 3){echo "Selected";} else { echo "disabled"; } ?>>Patient</option>
