	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT ENDS -->
					<table id="guest-dynamic-table" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		$('#guest-dynamic-table').DataTable( {
			...
			"order": [[ 0, "desc" ]],
			"ajax": {
			"url": "?controller=User&action=guestPatient1",
				"type": "POST",
				"dataType": "json",
			},
			 "columns": [
