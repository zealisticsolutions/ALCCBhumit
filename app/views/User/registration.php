					...
					<div class="row">
						...
						<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right email_address_patient required" for="form-field-1"> User Type </label>

								<div class="col-sm-4">
									<select class="chosen-select aura_select form-control user_type_patient" name="user_type" id="user_type" data-placeholder="Choose a State...">
										...
										<?php if(!empty($_SESSION["USER_TYPE"]) And $_SESSION["USER_TYPE"] == 1){ ?>
											...
											<option value="6" <?php if(!empty($_POST['user_type']) And $_POST['user_type'] == 6){echo "Selected";} ?>>Doctor</option>
											<option value="4" <?php if(!empty($_POST['user_type']) And $_POST['user_type'] == 4){echo "Selected";} ?>>Receptionist</option>
											<option value="7" <?php if(!empty($_POST['user_type']) And $_POST['user_type'] == 7){echo "Selected";} ?>>Manager</option>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right required" for="form-field-2"> Last Name </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-2" placeholder="Last Name"  name="lastname" value="<?php if(!empty($_POST['lastname'])){echo $_POST['lastname'];} ?>" class="col-xs-10 col-sm-5" />
							...
							<div class="form-group" id="password_div" style="<?php if(!empty($_POST['user_type'])){if($_POST['user_type'] ==3){echo 'display:none';}} ?>">
								...
								<div class="col-sm-9">
									<input type="password" id="form-field-3" placeholder="Password" name="password" value="<?php if(!empty($_POST['password'])){echo $_POST['password'];} ?>" class="col-xs-10 col-sm-5" />
							...
							<div class="form-group" id="c_password_div" style="<?php if(!empty($_POST['user_type'])){if($_POST['user_type'] ==3){echo 'display:none';}} ?>">
								...
								<div class="col-sm-9">
									<input type="password" id="form-field-4" placeholder="Confirm Password" name="c_password" value="<?php if(!empty($_POST['c_password'])){echo $_POST['c_password'];} ?>" class="col-xs-10 col-sm-5" />
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="datepicker" readonly  placeholder="DD-MM-YYYY" name="dob" value="<?php if(!empty($_POST['dob'])){echo $_POST['dob'];} ?>" class="from-control date-picker">	
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="datepicker2" placeholder="DD-MM-YYYY" readonly name="marriage_date" value="<?php if(!empty($_POST['marriage_date'])){echo $_POST['marriage_date'];} ?>" class="from-control date-picker">	
								</div>
							</div>
							...
							<div class="form-group" id="referred_by_div" style="<?php if(!empty($_POST['user_type'])){if($_POST['user_type'] !=3  ){echo 'display:none';}} ?>">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-5" placeholder="Referred By User's Mobile No" title="Please enter 10 digit mobile no."  pattern="[1-9]{1}[0-9]{9}" name="referred_id" value="<?php if(!empty($_POST['referred_id'])){echo $_POST['referred_id'];} ?>" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							...
							<div class="form-group">
								<label id="label_contact_no_id" class="col-sm-3 control-label no-padding-right required" for="form-field-1"> Mobile </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-6" placeholder="Contact Details"  name="contact_no" value="<?php if(!empty($_POST['contact_no'])){echo $_POST['contact_no'];} ?>" class="col-xs-10 col-sm-5" />
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-7" placeholder="Alternate Contact Details" name="contact_no_a" value="<?php if(!empty($_POST['contact_no_a'])){echo $_POST['contact_no_a'];} ?>" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-8" placeholder="Address" name="address" value="<?php if(!empty($_POST['address'])){echo $_POST['address'];} ?>" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-9" placeholder="Area" name="area" value="<?php if(!empty($_POST['area'])){echo $_POST['area'];} ?>" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-10" placeholder="Location" name="location" value="<?php if(!empty($_POST['location'])){echo $_POST['location'];} ?>" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-11" placeholder="City" name="city" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-12" placeholder="Pin Code" title="Please enter 6 digit PIN code." pattern="[1-9]{1}[0-9]{5}" name="pincode" value="<?php if(!empty($_POST['pincode'])){echo $_POST['pincode'];} ?>" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							...
							<div class="form-group">
								<label id="label_email_address_id" class="col-sm-3 control-label no-padding-right required" for="form-field-1"> Email Address </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-13" placeholder="Email Address" name="email_address" value="<?php if(!empty($_POST['email_address'])){echo $_POST['email_address'];} ?>" class="col-xs-10 col-sm-5" />
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="upload-btn-wrapper">
									  ...
									  <input type="file" accept="image/*;capture=camera" id="form-field-14" placeholder="Image Capture" name="picture" class="col-xs-10 col-sm-5" />
									</div>
								</div>	
							</div>
...
<script type="text/javascript">
	...
	$("#user_type").change(function(){
		...
		if($(this).val()==3){
			...
			$("#password_div").hide();
			$("#c_password_div").hide();
			$("#label_email_address_id").removeClass("required");
			$("#label_contact_no_id").removeClass("required");
		} else {
			$("#username_div").show();
			$("#password_div").show();
			$("#c_password_div").show();
			$("#label_email_address_id").addClass("required");
			$("#label_contact_no_id").addClass("required");
		}
		if($(this).val()!=3){
...
$(document).ready(function(){
	$(".user_type_patient").change(function(){
		if($(this).val()==3){
			$(".email_address_patient").removeClass("required");
		}else{
			$(".email_address_patient").addClass("required");
		}
	});
});
