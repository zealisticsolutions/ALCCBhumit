	...
	jQuery(function($) {
		...
		function loadBookingTable(){
			...
			$('#dynamic-table').DataTable( {
				...
				"order": [[ 6, "desc" ]],
				"ajax": {
				"url": "?controller=Receptionists&action=patientHistory&start_date="+start_date+"&end_date="+end_date+"&rooms="+rooms+"&doctor="+doctor+"&treatments="+treatments+"&patient_id="+patient_id,
					"type": "POST",
					"dataType": "json",
