						...
						<div class="vspace-12-sm"></div>	
							<div class="col-sm-12">
									...
									<div class="widget-box">
										...
										<div class="widget-body">
											<div class="widget-main">
												...
												<div class="row">
													<div class="col-xs-12 col-sm-12">
														<label class="required" for="id-date-picker-1">Available Therapists </label>
														<div class="">
								...
								<div class="widget-box">
										...
										<div class="widget-body">
											<div class="widget-main">
												<div class="row" id="available_slots"></div>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="modal-body">
					...
					<div class="col-sm-6"> 
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="email" id="email_address" placeholder="Email Address" name="email_address" value="" class="col-xs-10 col-sm-5 popup-field">
							</div>
						</div>
						<div class="form-group">
...
$("#categories").change(function(){
	...
	$('#doctors').empty();
	$('#doctors').append('<option value="">--Therapists--</option>');
  // alert($(this).val());
     $.ajax({
		type: 'POST',
		dataType: 'json',
