					...
					<div class="row">
						...
						<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="Treatment Name" name="srv_name" value="<?php if(!empty($service['srv_name'])){echo $service['srv_name'];} ?>" class="col-xs-10 col-sm-5" />
