					...
					<div class="row">
						...
						<!--<form class="form-inline" method="post">
							<select class="form-control aura_multiple_select" name="service_type" id="form-field-select-2">
								...
								<?php 
									$srvTypes = $tpl['result']['service_type'];
							...
							<button style = "margin-bottom: 4px;"type="submit" class="btn btn-info btn-sm">
								<i class="ace-icon fa fa-plus bigger-110"></i>Filter
							</button>
							<br>
							...
							?>
								<tr>
									...
									<td>
										<a href="?controller=AuraService&action=editService&id=<?php echo $patient['s_id']; ?>"><?php if(!empty($patient['srv_name'])) {echo  $patient['srv_name'];} else {echo "NA";} ?></a>
									</td>
									
									<td><?php  if(!empty($patient['amount'])) { echo  $patient['amount'];} else {echo "NA";}?></td>
									<td class="hidden-480">
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green" href="?controller=AuraService&action=editCService&id=<?php echo $patient['s_id']; ?>">
