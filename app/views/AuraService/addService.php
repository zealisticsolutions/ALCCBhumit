					...
					<div class="row">
						...
						<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right required" for="form-field-1"> Treatment Categories </label>
								...
								<div class="col-sm-4">
									<select class="form-control aura_multiple_select" name="service_type" id="form-field-select-2">
										...
										?>
										<option value="<?php echo $srvType['st_id']; ?>" <?php if(!empty($_POST['service_type']) And $_POST['service_type']==$srvType['st_id']){echo "selected";} ?>><?php echo $srvType['st_name'] ?></option>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right required" for="form-field-1"> Treatment Name </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="Treatment Name" name="srv_name" value="<?php if(!empty($_POST['srv_name'])){echo $_POST['srv_name'];} ?>" class="col-xs-10 col-sm-5" />
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="number" id="form-field-1" placeholder="Duration in minutes" name="duration" value="<?php if(!empty($_POST['duration'])){echo $_POST['duration'];} ?>" class="col-xs-10 col-sm-5" />
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right required" for="form-field-1"> Session Count/Number </label>
								<div class="col-sm-9">
									<input type="number" id="form-field-1" placeholder="No Of Session Required" name="session_required" value="<?php if(!empty($_POST['session_required'])){echo $_POST['session_required'];} ?>" class="col-xs-10 col-sm-5" />
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea rows="4" cols="43" placeholder="Description" name="description"><?php if(!empty($_POST['description'])){echo $_POST['description'];} ?></textarea>
