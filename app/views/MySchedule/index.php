					...
					<form class="form-horizontal" method="post">
						...
						<div id="put_in" style="margin-left: 0%;">
							<div class="form-group" id="take_it">
								<div class="input-group custom_datepicker pull-center" style="width: 50%;margin-bottom: 1%;" data-placement="left" data-align="top" data-autoclose="true">
									<input class="clockpicker" type="text" required name="start_time[]" placeholder="HH:MM" title="HH:MM time format">
								</div>
								<div class="input-group1 custom_datepicker pull-center" style="width: 50%;margin-bottom: 1%;" data-placement="left" data-align="top" data-autoclose="true">
									<input type="text" class="clockpicker1" required name="end_time[]" placeholder="HH:MM" title="HH:MM time format">
								</div>
							</div>
						</div>
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							?>
								<tr>
									...
									<td><?php  if(!empty($patient['start_time'])) { echo  date("h:i A",strtotime($patient['start_time'])); } else { echo "NA"; } ?></td>
									<td><?php if(!empty($patient['end_time'])){ echo  date("h:i A",strtotime($patient['end_time'])); } else { echo "NA"; } ?></td>
								</tr>
								<?php 
									}
								?>
